...
public static class ModelSeed
{
    ...
    public static List<Model> CreateModels()
    {
        var models = new List<Model>()
        {
            ...
            Model.Create(string.Join(" ", CategoryEnum.Lingerie.GetDescription(), nameof(Model))).Value,
            Model.Create(string.Join(" ", CategoryEnum.Tops.GetDescription(), nameof(Model))).Value,
